...
const COLORS = ['#8B5CF6', '#7C3AED', '#6D28D9', '#A78BFA', '#C4B5FD', '#1F4E79', '#3B82F6', '#10B981', '#F59E0B', '#06B6D4']
...
export default function PMDepartmentBar({ data }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={dynamicHeight}>
      <BarChart data={sorted} layout="vertical" margin={{ top: 4, right: 16, left: 8, bottom: 0 }} barSize={18}>
        ...
        <YAxis type="category" dataKey="name" width={150} tick={{ fontSize: 11, fill: 'var(--muted)' }} axisLine={false} tickLine={false} />
