...
const COLORS = ['#1F4E79', '#2563A8', '#3B82F6', '#60A5FA', '#10B981', '#F59E0B', '#8B5CF6', '#EF4444', '#06B6D4']
...
export default function ProjectStatusBar({ data }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={dynamicHeight}>
      <BarChart data={sorted} layout="vertical" margin={{ top: 4, right: 16, left: 8, bottom: 0 }} barSize={20}>
